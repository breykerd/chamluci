...
var fcategoriasedit = currentForm = new ew.Form("fcategoriasedit", "edit");
...
fcategoriasedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($categorias_edit->img_header->Required) { ?>
		...
		<?php } ?>
		<?php if ($categorias_edit->titulo->Required) { ?>
		...
		<?php } ?>
		<?php if ($categorias_edit->url->Required) { ?>
		...
		<?php } ?>
		<?php if ($categorias_edit->keywords->Required) { ?>
		...
		<?php } ?>
		<?php if ($categorias_edit->description->Required) { ?>
...
fcategoriasedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php if ($categorias_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $categorias_edit->Token ?>">
<?php } ?>
...
<?php if ($categorias->img_header->Visible) { // img_header ?>
	<div id="r_img_header" class="form-group row">
		<label id="elh_categorias_img_header" class="<?php echo $categorias_edit->LeftColumnClass ?>"><?php echo $categorias->img_header->caption() ?><?php echo ($categorias->img_header->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $categorias_edit->RightColumnClass ?>"><div<?php echo $categorias->img_header->cellAttributes() ?>>
...
<?php if (Post("fa_x_img_header") == "0") { ?>
<input type="hidden" name="fa_x_img_header" id= "fa_x_img_header" value="0">
<?php } else { ?>
<input type="hidden" name="fa_x_img_header" id= "fa_x_img_header" value="1">
<?php } ?>
...
<?php if ($categorias->titulo->Visible) { // titulo ?>
	<div id="r_titulo" class="form-group row">
		<label id="elh_categorias_titulo" for="x_titulo" class="<?php echo $categorias_edit->LeftColumnClass ?>"><?php echo $categorias->titulo->caption() ?><?php echo ($categorias->titulo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $categorias_edit->RightColumnClass ?>"><div<?php echo $categorias->titulo->cellAttributes() ?>>
...
<?php if ($categorias->url->Visible) { // url ?>
	<div id="r_url" class="form-group row">
		<label id="elh_categorias_url" for="x_url" class="<?php echo $categorias_edit->LeftColumnClass ?>"><?php echo $categorias->url->caption() ?><?php echo ($categorias->url->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $categorias_edit->RightColumnClass ?>"><div<?php echo $categorias->url->cellAttributes() ?>>
...
<?php if ($categorias->keywords->Visible) { // keywords ?>
	<div id="r_keywords" class="form-group row">
		<label id="elh_categorias_keywords" for="x_keywords" class="<?php echo $categorias_edit->LeftColumnClass ?>"><?php echo $categorias->keywords->caption() ?><?php echo ($categorias->keywords->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $categorias_edit->RightColumnClass ?>"><div<?php echo $categorias->keywords->cellAttributes() ?>>
...
<?php if ($categorias->description->Visible) { // description ?>
	<div id="r_description" class="form-group row">
		<label id="elh_categorias_description" for="x_description" class="<?php echo $categorias_edit->LeftColumnClass ?>"><?php echo $categorias->description->caption() ?><?php echo ($categorias->description->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $categorias_edit->RightColumnClass ?>"><div<?php echo $categorias->description->cellAttributes() ?>>
...
<?php } ?>
	...
	<input type="hidden" data-table="categorias" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($categorias->id->CurrentValue) ?>">
<?php
	if (in_array("productos", explode(",", $categorias->getCurrentDetailTable())) && $productos->DetailEdit) {
?>
