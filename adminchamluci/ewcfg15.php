...
define(PROJECT_NAMESPACE . "RANDOM_KEY", 'tpAQ40dOEyY7838I'); // Random key for encryption
...
$PROJECT_ID = "{5B4DA292-B8B0-4B7A-BB01-3B5D66F23446}"; // Project ID (GUID)
$RELATED_PROJECT_ID = "";
...
$CONNECTIONS["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "corporio_corporac_chan", "qs" => "`", "qe" => "`");
...
define(PROJECT_NAMESPACE . "LOGIN_USERNAME_FIELD_NAME", "user");
...
define(PROJECT_NAMESPACE . "USER_NAME_FILTER", "(`user` = '%u')");
...
define(PROJECT_NAMESPACE . "UPLOAD_DEST_PATH", "img/"); // Upload destination path (relative to app root)
...
define(PROJECT_NAMESPACE . "UPLOAD_ALLOWED_FILE_EXT", "gif,jpg,jpeg,bmp,png,doc,docx,xls,xlsx,pdf,zip,jxr,webp"); // Allowed file extensions
