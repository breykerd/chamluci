...
var fcontacoedit = currentForm = new ew.Form("fcontacoedit", "edit");

// Validate form
fcontacoedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($contaco_edit->correo->Required) { ?>
		...
		<?php } ?>
		<?php if ($contaco_edit->direccion->Required) { ?>
		...
		<?php } ?>
		<?php if ($contaco_edit->tel1->Required) { ?>
		...
		<?php } ?>
		<?php if ($contaco_edit->tel2->Required) { ?>
		...
		<?php } ?>
		<?php if ($contaco_edit->tel3->Required) { ?>
		...
		<?php } ?>
		<?php if ($contaco_edit->tel4->Required) { ?>
		...
		<?php } ?>
		<?php if ($contaco_edit->tel5->Required) { ?>
		...
		<?php } ?>
		<?php if ($contaco_edit->horario->Required) { ?>
		...
		<?php } ?>
		<?php if ($contaco_edit->img_bcp->Required) { ?>
		...
		<?php } ?>
		<?php if ($contaco_edit->t_bcp1->Required) { ?>
		...
		<?php } ?>
		<?php if ($contaco_edit->t_bcp2->Required) { ?>
		...
		<?php } ?>
		<?php if ($contaco_edit->t_bcp3->Required) { ?>
		...
		<?php } ?>
		<?php if ($contaco_edit->img_bbva->Required) { ?>
		...
		<?php } ?>
		<?php if ($contaco_edit->t_bbva_1->Required) { ?>
		...
		<?php } ?>
		<?php if ($contaco_edit->t_bbva_2->Required) { ?>
		...
		<?php } ?>
		<?php if ($contaco_edit->t_bbva_3->Required) { ?>
		...
		<?php } ?>
		<?php if ($contaco_edit->fa->Required) { ?>
		...
		<?php } ?>
		<?php if ($contaco_edit->tw->Required) { ?>
		...
		<?php } ?>
		<?php if ($contaco_edit->in->Required) { ?>
		...
		<?php } ?>
		<?php if ($contaco_edit->go->Required) { ?>
		...
		<?php } ?>
		<?php if ($contaco_edit->you->Required) { ?>
		...
		<?php } ?>
		<?php if ($contaco_edit->correo_formulario->Required) { ?>
		...
		<?php } ?>
		<?php if ($contaco_edit->keywords->Required) { ?>
		...
		<?php } ?>
		<?php if ($contaco_edit->description->Required) { ?>
...
fcontacoedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fcontacoedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php $contaco_edit->showPageHeader(); ?>
<?php
$contaco_edit->showMessage();
?>
<form name="fcontacoedit" id="fcontacoedit" class="<?php echo $contaco_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($contaco_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $contaco_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="contaco">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$contaco_edit->IsModal ?>">
<div class="ew-edit-div"><!-- page* -->
<?php if ($contaco->correo->Visible) { // correo ?>
	<div id="r_correo" class="form-group row">
		<label id="elh_contaco_correo" for="x_correo" class="<?php echo $contaco_edit->LeftColumnClass ?>"><?php echo $contaco->correo->caption() ?><?php echo ($contaco->correo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $contaco_edit->RightColumnClass ?>"><div<?php echo $contaco->correo->cellAttributes() ?>>
...
<?php if ($contaco->direccion->Visible) { // direccion ?>
	<div id="r_direccion" class="form-group row">
		<label id="elh_contaco_direccion" for="x_direccion" class="<?php echo $contaco_edit->LeftColumnClass ?>"><?php echo $contaco->direccion->caption() ?><?php echo ($contaco->direccion->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $contaco_edit->RightColumnClass ?>"><div<?php echo $contaco->direccion->cellAttributes() ?>>
...
<?php if ($contaco->tel1->Visible) { // tel1 ?>
	<div id="r_tel1" class="form-group row">
		<label id="elh_contaco_tel1" for="x_tel1" class="<?php echo $contaco_edit->LeftColumnClass ?>"><?php echo $contaco->tel1->caption() ?><?php echo ($contaco->tel1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $contaco_edit->RightColumnClass ?>"><div<?php echo $contaco->tel1->cellAttributes() ?>>
...
<?php if ($contaco->tel2->Visible) { // tel2 ?>
	<div id="r_tel2" class="form-group row">
		<label id="elh_contaco_tel2" for="x_tel2" class="<?php echo $contaco_edit->LeftColumnClass ?>"><?php echo $contaco->tel2->caption() ?><?php echo ($contaco->tel2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $contaco_edit->RightColumnClass ?>"><div<?php echo $contaco->tel2->cellAttributes() ?>>
...
<?php if ($contaco->tel3->Visible) { // tel3 ?>
	<div id="r_tel3" class="form-group row">
		<label id="elh_contaco_tel3" for="x_tel3" class="<?php echo $contaco_edit->LeftColumnClass ?>"><?php echo $contaco->tel3->caption() ?><?php echo ($contaco->tel3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $contaco_edit->RightColumnClass ?>"><div<?php echo $contaco->tel3->cellAttributes() ?>>
...
<?php if ($contaco->tel4->Visible) { // tel4 ?>
	<div id="r_tel4" class="form-group row">
		<label id="elh_contaco_tel4" for="x_tel4" class="<?php echo $contaco_edit->LeftColumnClass ?>"><?php echo $contaco->tel4->caption() ?><?php echo ($contaco->tel4->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $contaco_edit->RightColumnClass ?>"><div<?php echo $contaco->tel4->cellAttributes() ?>>
...
<?php if ($contaco->tel5->Visible) { // tel5 ?>
	<div id="r_tel5" class="form-group row">
		<label id="elh_contaco_tel5" for="x_tel5" class="<?php echo $contaco_edit->LeftColumnClass ?>"><?php echo $contaco->tel5->caption() ?><?php echo ($contaco->tel5->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $contaco_edit->RightColumnClass ?>"><div<?php echo $contaco->tel5->cellAttributes() ?>>
...
<?php if ($contaco->horario->Visible) { // horario ?>
	<div id="r_horario" class="form-group row">
		<label id="elh_contaco_horario" for="x_horario" class="<?php echo $contaco_edit->LeftColumnClass ?>"><?php echo $contaco->horario->caption() ?><?php echo ($contaco->horario->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $contaco_edit->RightColumnClass ?>"><div<?php echo $contaco->horario->cellAttributes() ?>>
...
<?php if ($contaco->img_bcp->Visible) { // img_bcp ?>
	<div id="r_img_bcp" class="form-group row">
		<label id="elh_contaco_img_bcp" class="<?php echo $contaco_edit->LeftColumnClass ?>"><?php echo $contaco->img_bcp->caption() ?><?php echo ($contaco->img_bcp->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $contaco_edit->RightColumnClass ?>"><div<?php echo $contaco->img_bcp->cellAttributes() ?>>
...
<?php if (Post("fa_x_img_bcp") == "0") { ?>
<input type="hidden" name="fa_x_img_bcp" id= "fa_x_img_bcp" value="0">
<?php } else { ?>
<input type="hidden" name="fa_x_img_bcp" id= "fa_x_img_bcp" value="1">
<?php } ?>
...
<?php if ($contaco->t_bcp1->Visible) { // t_bcp1 ?>
	<div id="r_t_bcp1" class="form-group row">
		<label id="elh_contaco_t_bcp1" for="x_t_bcp1" class="<?php echo $contaco_edit->LeftColumnClass ?>"><?php echo $contaco->t_bcp1->caption() ?><?php echo ($contaco->t_bcp1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $contaco_edit->RightColumnClass ?>"><div<?php echo $contaco->t_bcp1->cellAttributes() ?>>
...
<?php if ($contaco->t_bcp2->Visible) { // t_bcp2 ?>
	<div id="r_t_bcp2" class="form-group row">
		<label id="elh_contaco_t_bcp2" for="x_t_bcp2" class="<?php echo $contaco_edit->LeftColumnClass ?>"><?php echo $contaco->t_bcp2->caption() ?><?php echo ($contaco->t_bcp2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $contaco_edit->RightColumnClass ?>"><div<?php echo $contaco->t_bcp2->cellAttributes() ?>>
...
<?php if ($contaco->t_bcp3->Visible) { // t_bcp3 ?>
	<div id="r_t_bcp3" class="form-group row">
		<label id="elh_contaco_t_bcp3" for="x_t_bcp3" class="<?php echo $contaco_edit->LeftColumnClass ?>"><?php echo $contaco->t_bcp3->caption() ?><?php echo ($contaco->t_bcp3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $contaco_edit->RightColumnClass ?>"><div<?php echo $contaco->t_bcp3->cellAttributes() ?>>
...
<?php if ($contaco->img_bbva->Visible) { // img_bbva ?>
	<div id="r_img_bbva" class="form-group row">
		<label id="elh_contaco_img_bbva" class="<?php echo $contaco_edit->LeftColumnClass ?>"><?php echo $contaco->img_bbva->caption() ?><?php echo ($contaco->img_bbva->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $contaco_edit->RightColumnClass ?>"><div<?php echo $contaco->img_bbva->cellAttributes() ?>>
...
<?php if (Post("fa_x_img_bbva") == "0") { ?>
<input type="hidden" name="fa_x_img_bbva" id= "fa_x_img_bbva" value="0">
<?php } else { ?>
<input type="hidden" name="fa_x_img_bbva" id= "fa_x_img_bbva" value="1">
<?php } ?>
...
<?php if ($contaco->t_bbva_1->Visible) { // t_bbva_1 ?>
	<div id="r_t_bbva_1" class="form-group row">
		<label id="elh_contaco_t_bbva_1" for="x_t_bbva_1" class="<?php echo $contaco_edit->LeftColumnClass ?>"><?php echo $contaco->t_bbva_1->caption() ?><?php echo ($contaco->t_bbva_1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $contaco_edit->RightColumnClass ?>"><div<?php echo $contaco->t_bbva_1->cellAttributes() ?>>
...
<?php if ($contaco->t_bbva_2->Visible) { // t_bbva_2 ?>
	<div id="r_t_bbva_2" class="form-group row">
		<label id="elh_contaco_t_bbva_2" for="x_t_bbva_2" class="<?php echo $contaco_edit->LeftColumnClass ?>"><?php echo $contaco->t_bbva_2->caption() ?><?php echo ($contaco->t_bbva_2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $contaco_edit->RightColumnClass ?>"><div<?php echo $contaco->t_bbva_2->cellAttributes() ?>>
...
<?php if ($contaco->t_bbva_3->Visible) { // t_bbva_3 ?>
	<div id="r_t_bbva_3" class="form-group row">
		<label id="elh_contaco_t_bbva_3" for="x_t_bbva_3" class="<?php echo $contaco_edit->LeftColumnClass ?>"><?php echo $contaco->t_bbva_3->caption() ?><?php echo ($contaco->t_bbva_3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $contaco_edit->RightColumnClass ?>"><div<?php echo $contaco->t_bbva_3->cellAttributes() ?>>
...
<?php if ($contaco->fa->Visible) { // fa ?>
	<div id="r_fa" class="form-group row">
		<label id="elh_contaco_fa" for="x_fa" class="<?php echo $contaco_edit->LeftColumnClass ?>"><?php echo $contaco->fa->caption() ?><?php echo ($contaco->fa->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $contaco_edit->RightColumnClass ?>"><div<?php echo $contaco->fa->cellAttributes() ?>>
...
<?php if ($contaco->tw->Visible) { // tw ?>
	<div id="r_tw" class="form-group row">
		<label id="elh_contaco_tw" for="x_tw" class="<?php echo $contaco_edit->LeftColumnClass ?>"><?php echo $contaco->tw->caption() ?><?php echo ($contaco->tw->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $contaco_edit->RightColumnClass ?>"><div<?php echo $contaco->tw->cellAttributes() ?>>
...
<?php if ($contaco->in->Visible) { // in ?>
	<div id="r_in" class="form-group row">
		<label id="elh_contaco_in" for="x_in" class="<?php echo $contaco_edit->LeftColumnClass ?>"><?php echo $contaco->in->caption() ?><?php echo ($contaco->in->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $contaco_edit->RightColumnClass ?>"><div<?php echo $contaco->in->cellAttributes() ?>>
...
<?php if ($contaco->go->Visible) { // go ?>
	<div id="r_go" class="form-group row">
		<label id="elh_contaco_go" for="x_go" class="<?php echo $contaco_edit->LeftColumnClass ?>"><?php echo $contaco->go->caption() ?><?php echo ($contaco->go->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $contaco_edit->RightColumnClass ?>"><div<?php echo $contaco->go->cellAttributes() ?>>
...
<?php if ($contaco->you->Visible) { // you ?>
	<div id="r_you" class="form-group row">
		<label id="elh_contaco_you" for="x_you" class="<?php echo $contaco_edit->LeftColumnClass ?>"><?php echo $contaco->you->caption() ?><?php echo ($contaco->you->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $contaco_edit->RightColumnClass ?>"><div<?php echo $contaco->you->cellAttributes() ?>>
...
<?php if ($contaco->correo_formulario->Visible) { // correo_formulario ?>
	<div id="r_correo_formulario" class="form-group row">
		<label id="elh_contaco_correo_formulario" for="x_correo_formulario" class="<?php echo $contaco_edit->LeftColumnClass ?>"><?php echo $contaco->correo_formulario->caption() ?><?php echo ($contaco->correo_formulario->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $contaco_edit->RightColumnClass ?>"><div<?php echo $contaco->correo_formulario->cellAttributes() ?>>
...
<?php if ($contaco->keywords->Visible) { // keywords ?>
	<div id="r_keywords" class="form-group row">
		<label id="elh_contaco_keywords" for="x_keywords" class="<?php echo $contaco_edit->LeftColumnClass ?>"><?php echo $contaco->keywords->caption() ?><?php echo ($contaco->keywords->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $contaco_edit->RightColumnClass ?>"><div<?php echo $contaco->keywords->cellAttributes() ?>>
...
<?php if ($contaco->description->Visible) { // description ?>
	<div id="r_description" class="form-group row">
		<label id="elh_contaco_description" for="x_description" class="<?php echo $contaco_edit->LeftColumnClass ?>"><?php echo $contaco->description->caption() ?><?php echo ($contaco->description->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $contaco_edit->RightColumnClass ?>"><div<?php echo $contaco->description->cellAttributes() ?>>
...
<?php } ?>
	...
	<input type="hidden" data-table="contaco" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($contaco->id->CurrentValue) ?>">
<?php if (!$contaco_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $contaco_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $contaco_edit->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$contaco_edit->showPageFooter();
if (DEBUG_ENABLED)
