...
var fheaderadd = currentForm = new ew.Form("fheaderadd", "add");

// Validate form
fheaderadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($header_add->img_empresa->Required) { ?>
		...
		<?php } ?>
		<?php if ($header_add->img_blog->Required) { ?>
		...
		<?php } ?>
		<?php if ($header_add->img_contacto->Required) { ?>
		...
		<?php } ?>
		<?php if ($header_add->img_pasarela->Required) { ?>
...
fheaderadd.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fheaderadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php $header_add->showPageHeader(); ?>
<?php
$header_add->showMessage();
?>
<form name="fheaderadd" id="fheaderadd" class="<?php echo $header_add->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($header_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $header_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="header">
<input type="hidden" name="action" id="action" value="insert">
<input type="hidden" name="modal" value="<?php echo (int)$header_add->IsModal ?>">
<div class="ew-add-div"><!-- page* -->
<?php if ($header->img_empresa->Visible) { // img_empresa ?>
	<div id="r_img_empresa" class="form-group row">
		<label id="elh_header_img_empresa" class="<?php echo $header_add->LeftColumnClass ?>"><?php echo $header->img_empresa->caption() ?><?php echo ($header->img_empresa->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $header_add->RightColumnClass ?>"><div<?php echo $header->img_empresa->cellAttributes() ?>>
...
<?php if ($header->img_blog->Visible) { // img_blog ?>
	<div id="r_img_blog" class="form-group row">
		<label id="elh_header_img_blog" class="<?php echo $header_add->LeftColumnClass ?>"><?php echo $header->img_blog->caption() ?><?php echo ($header->img_blog->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $header_add->RightColumnClass ?>"><div<?php echo $header->img_blog->cellAttributes() ?>>
...
<?php if ($header->img_contacto->Visible) { // img_contacto ?>
	<div id="r_img_contacto" class="form-group row">
		<label id="elh_header_img_contacto" class="<?php echo $header_add->LeftColumnClass ?>"><?php echo $header->img_contacto->caption() ?><?php echo ($header->img_contacto->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $header_add->RightColumnClass ?>"><div<?php echo $header->img_contacto->cellAttributes() ?>>
...
<?php if ($header->img_pasarela->Visible) { // img_pasarela ?>
	<div id="r_img_pasarela" class="form-group row">
		<label id="elh_header_img_pasarela" class="<?php echo $header_add->LeftColumnClass ?>"><?php echo $header->img_pasarela->caption() ?><?php echo ($header->img_pasarela->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $header_add->RightColumnClass ?>"><div<?php echo $header->img_pasarela->cellAttributes() ?>>
...
<?php if (!$header_add->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $header_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("AddBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $header_add->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$header_add->showPageFooter();
if (DEBUG_ENABLED)
