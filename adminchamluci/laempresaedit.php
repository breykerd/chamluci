...
// Create page object
$laempresa_edit = new laempresa_edit();
...
var flaempresaedit = currentForm = new ew.Form("flaempresaedit", "edit");

// Validate form
flaempresaedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($laempresa_edit->img->Required) { ?>
		...
		<?php } ?>
		<?php if ($laempresa_edit->titulo->Required) { ?>
		...
		<?php } ?>
		<?php if ($laempresa_edit->detalle->Required) { ?>
		...
		<?php } ?>
		<?php if ($laempresa_edit->keywords->Required) { ?>
		...
		<?php } ?>
		<?php if ($laempresa_edit->description->Required) { ?>
		...
		<?php } ?>
		<?php if ($laempresa_edit->tituloimg->Required) { ?>
...
flaempresaedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
flaempresaedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php $laempresa_edit->showPageHeader(); ?>
<?php
$laempresa_edit->showMessage();
?>
<form name="flaempresaedit" id="flaempresaedit" class="<?php echo $laempresa_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($laempresa_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $laempresa_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="laempresa">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$laempresa_edit->IsModal ?>">
<div class="ew-edit-div"><!-- page* -->
<?php if ($laempresa->img->Visible) { // img ?>
	<div id="r_img" class="form-group row">
		<label id="elh_laempresa_img" class="<?php echo $laempresa_edit->LeftColumnClass ?>"><?php echo $laempresa->img->caption() ?><?php echo ($laempresa->img->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $laempresa_edit->RightColumnClass ?>"><div<?php echo $laempresa->img->cellAttributes() ?>>
...
<?php if ($laempresa->titulo->Visible) { // titulo ?>
	<div id="r_titulo" class="form-group row">
		<label id="elh_laempresa_titulo" for="x_titulo" class="<?php echo $laempresa_edit->LeftColumnClass ?>"><?php echo $laempresa->titulo->caption() ?><?php echo ($laempresa->titulo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $laempresa_edit->RightColumnClass ?>"><div<?php echo $laempresa->titulo->cellAttributes() ?>>
...
<?php if ($laempresa->detalle->Visible) { // detalle ?>
	<div id="r_detalle" class="form-group row">
		<label id="elh_laempresa_detalle" class="<?php echo $laempresa_edit->LeftColumnClass ?>"><?php echo $laempresa->detalle->caption() ?><?php echo ($laempresa->detalle->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $laempresa_edit->RightColumnClass ?>"><div<?php echo $laempresa->detalle->cellAttributes() ?>>
...
<script>
ew.createEditor("flaempresaedit", "x_detalle", 35, 4, <?php echo ($laempresa->detalle->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
...
<?php if ($laempresa->keywords->Visible) { // keywords ?>
	<div id="r_keywords" class="form-group row">
		<label id="elh_laempresa_keywords" for="x_keywords" class="<?php echo $laempresa_edit->LeftColumnClass ?>"><?php echo $laempresa->keywords->caption() ?><?php echo ($laempresa->keywords->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $laempresa_edit->RightColumnClass ?>"><div<?php echo $laempresa->keywords->cellAttributes() ?>>
...
<?php if ($laempresa->description->Visible) { // description ?>
	<div id="r_description" class="form-group row">
		<label id="elh_laempresa_description" for="x_description" class="<?php echo $laempresa_edit->LeftColumnClass ?>"><?php echo $laempresa->description->caption() ?><?php echo ($laempresa->description->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $laempresa_edit->RightColumnClass ?>"><div<?php echo $laempresa->description->cellAttributes() ?>>
...
<?php if ($laempresa->tituloimg->Visible) { // tituloimg ?>
	<div id="r_tituloimg" class="form-group row">
		<label id="elh_laempresa_tituloimg" for="x_tituloimg" class="<?php echo $laempresa_edit->LeftColumnClass ?>"><?php echo $laempresa->tituloimg->caption() ?><?php echo ($laempresa->tituloimg->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $laempresa_edit->RightColumnClass ?>"><div<?php echo $laempresa->tituloimg->cellAttributes() ?>>
...
<?php } ?>
	...
	<input type="hidden" data-table="laempresa" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($laempresa->id->CurrentValue) ?>">
<?php if (!$laempresa_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $laempresa_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $laempresa_edit->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$laempresa_edit->showPageFooter();
if (DEBUG_ENABLED)
