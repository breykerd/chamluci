 ...
 * Page class
 */
class slider_view extends slider
{
	...
	// Page object name
	public $PageObjName = "slider_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "sliderlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "sliderlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "sliderlist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
