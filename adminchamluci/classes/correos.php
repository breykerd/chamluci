...
/**
 * Table class for correos
 */
class correos extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'correos';
		$this->TableName = 'correos';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`correos`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new DbField('correos', 'correos', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// nombre
		$this->nombre = new DbField('correos', 'correos', 'x_nombre', 'nombre', '`nombre`', '`nombre`', 200, -1, FALSE, '`nombre`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nombre->Sortable = TRUE; // Allow sort
		$this->fields['nombre'] = &$this->nombre;

		// correo
		$this->correo = new DbField('correos', 'correos', 'x_correo', 'correo', '`correo`', '`correo`', 200, -1, FALSE, '`correo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->correo->Sortable = TRUE; // Allow sort
		$this->fields['correo'] = &$this->correo;

		// hora
		$this->hora = new DbField('correos', 'correos', 'x_hora', 'hora', '`hora`', CastDateFieldForLike('`hora`', 4, "DB"), 134, 4, FALSE, '`hora`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// fecha
		$this->fecha = new DbField('correos', 'correos', 'x_fecha', 'fecha', '`fecha`', CastDateFieldForLike('`fecha`', 0, "DB"), 133, 0, FALSE, '`fecha`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom <> "") ? $this->SqlFrom : "`correos`";
	}
	...
	{
		global $Language;
		if ($pageName == "correosview.php")
			return $Language->phrase("View");
		elseif ($pageName == "correosedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "correosadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("correosview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("correosview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "correosadd.php?" . $this->getUrlParm($parm);
		else
			$url = "correosadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("correosedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("correosadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("correosdelete.php", $this->getUrlParm());
	}
