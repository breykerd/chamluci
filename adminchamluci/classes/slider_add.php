 ...
 * Page class
 */
class slider_add extends slider
{
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "sliderview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->t1->CurrentValue = NULL;
		$this->t1->OldValue = $this->t1->CurrentValue;
		$this->t2->CurrentValue = NULL;
		$this->t2->OldValue = $this->t2->CurrentValue;
	...
	protected function newRow()
	{
		...
		$row['t1'] = $this->t1->CurrentValue;
		$row['t2'] = $this->t2->CurrentValue;
	...
	protected function addRow($rsold = NULL)
	{
		...
		// t1
		$this->t1->setDbValueDef($rsnew, $this->t1->CurrentValue, NULL, FALSE);

		// t2
		$this->t2->setDbValueDef($rsnew, $this->t2->CurrentValue, NULL, FALSE);
