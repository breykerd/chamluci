 ...
 * Page class
 */
class productos_list extends productos
{
	...
	// Page object name
	public $PageObjName = "productos_list";

	// Grid form hidden field names
	public $FormName = "fproductoslist";
	...
	public function __construct()
	{
		...
		$this->FilterOptions->TagClassName = "ew-filter-option fproductoslistsrch";
	...
	public function getFilterList()
	{
		...
		$filterList = Concat($filterList, $this->img1->AdvancedSearch->toJson(), ","); // Field img1
		$filterList = Concat($filterList, $this->img2->AdvancedSearch->toJson(), ","); // Field img2
		$filterList = Concat($filterList, $this->img3->AdvancedSearch->toJson(), ","); // Field img3
		$filterList = Concat($filterList, $this->img4->AdvancedSearch->toJson(), ","); // Field img4
		$filterList = Concat($filterList, $this->img5->AdvancedSearch->toJson(), ","); // Field img5
		$filterList = Concat($filterList, $this->img6->AdvancedSearch->toJson(), ","); // Field img6
		$filterList = Concat($filterList, $this->img7->AdvancedSearch->toJson(), ","); // Field img7
		$filterList = Concat($filterList, $this->img8->AdvancedSearch->toJson(), ","); // Field img8
		$filterList = Concat($filterList, $this->img9->AdvancedSearch->toJson(), ","); // Field img9
		$filterList = Concat($filterList, $this->destacado_inicio->AdvancedSearch->toJson(), ","); // Field destacado_inicio
		$filterList = Concat($filterList, $this->destacado_footer->AdvancedSearch->toJson(), ","); // Field destacado_footer
		$filterList = Concat($filterList, $this->destacado_productos->AdvancedSearch->toJson(), ","); // Field destacado_productos
		$filterList = Concat($filterList, $this->id_cate->AdvancedSearch->toJson(), ","); // Field id_cate
		$filterList = Concat($filterList, $this->ficha_tecnica->AdvancedSearch->toJson(), ","); // Field ficha_tecnica
		$filterList = Concat($filterList, $this->img_principal->AdvancedSearch->toJson(), ","); // Field img_principal
	...
	protected function restoreFilterList()
	{
		...
		// Field img6
		$this->img6->AdvancedSearch->SearchValue = @$filter["x_img6"];
		$this->img6->AdvancedSearch->SearchOperator = @$filter["z_img6"];
		$this->img6->AdvancedSearch->SearchCondition = @$filter["v_img6"];
		$this->img6->AdvancedSearch->SearchValue2 = @$filter["y_img6"];
		$this->img6->AdvancedSearch->SearchOperator2 = @$filter["w_img6"];
		$this->img6->AdvancedSearch->save();

		// Field img7
		$this->img7->AdvancedSearch->SearchValue = @$filter["x_img7"];
		$this->img7->AdvancedSearch->SearchOperator = @$filter["z_img7"];
		$this->img7->AdvancedSearch->SearchCondition = @$filter["v_img7"];
		$this->img7->AdvancedSearch->SearchValue2 = @$filter["y_img7"];
		$this->img7->AdvancedSearch->SearchOperator2 = @$filter["w_img7"];
		$this->img7->AdvancedSearch->save();

		// Field img8
		$this->img8->AdvancedSearch->SearchValue = @$filter["x_img8"];
		$this->img8->AdvancedSearch->SearchOperator = @$filter["z_img8"];
		$this->img8->AdvancedSearch->SearchCondition = @$filter["v_img8"];
		$this->img8->AdvancedSearch->SearchValue2 = @$filter["y_img8"];
		$this->img8->AdvancedSearch->SearchOperator2 = @$filter["w_img8"];
		$this->img8->AdvancedSearch->save();

		// Field img9
		$this->img9->AdvancedSearch->SearchValue = @$filter["x_img9"];
		$this->img9->AdvancedSearch->SearchOperator = @$filter["z_img9"];
		$this->img9->AdvancedSearch->SearchCondition = @$filter["v_img9"];
		$this->img9->AdvancedSearch->SearchValue2 = @$filter["y_img9"];
		$this->img9->AdvancedSearch->SearchOperator2 = @$filter["w_img9"];
		$this->img9->AdvancedSearch->save();

		// Field destacado_inicio
		$this->destacado_inicio->AdvancedSearch->SearchValue = @$filter["x_destacado_inicio"];
		$this->destacado_inicio->AdvancedSearch->SearchOperator = @$filter["z_destacado_inicio"];
		$this->destacado_inicio->AdvancedSearch->SearchCondition = @$filter["v_destacado_inicio"];
		$this->destacado_inicio->AdvancedSearch->SearchValue2 = @$filter["y_destacado_inicio"];
		$this->destacado_inicio->AdvancedSearch->SearchOperator2 = @$filter["w_destacado_inicio"];
		$this->destacado_inicio->AdvancedSearch->save();

		// Field destacado_footer
		$this->destacado_footer->AdvancedSearch->SearchValue = @$filter["x_destacado_footer"];
		$this->destacado_footer->AdvancedSearch->SearchOperator = @$filter["z_destacado_footer"];
		$this->destacado_footer->AdvancedSearch->SearchCondition = @$filter["v_destacado_footer"];
		$this->destacado_footer->AdvancedSearch->SearchValue2 = @$filter["y_destacado_footer"];
		$this->destacado_footer->AdvancedSearch->SearchOperator2 = @$filter["w_destacado_footer"];
		$this->destacado_footer->AdvancedSearch->save();

		// Field destacado_productos
		$this->destacado_productos->AdvancedSearch->SearchValue = @$filter["x_destacado_productos"];
		$this->destacado_productos->AdvancedSearch->SearchOperator = @$filter["z_destacado_productos"];
		$this->destacado_productos->AdvancedSearch->SearchCondition = @$filter["v_destacado_productos"];
		$this->destacado_productos->AdvancedSearch->SearchValue2 = @$filter["y_destacado_productos"];
		$this->destacado_productos->AdvancedSearch->SearchOperator2 = @$filter["w_destacado_productos"];
		$this->destacado_productos->AdvancedSearch->save();

		// Field id_cate
		$this->id_cate->AdvancedSearch->SearchValue = @$filter["x_id_cate"];
		$this->id_cate->AdvancedSearch->SearchOperator = @$filter["z_id_cate"];
		$this->id_cate->AdvancedSearch->SearchCondition = @$filter["v_id_cate"];
		$this->id_cate->AdvancedSearch->SearchValue2 = @$filter["y_id_cate"];
		$this->id_cate->AdvancedSearch->SearchOperator2 = @$filter["w_id_cate"];
		$this->id_cate->AdvancedSearch->save();

		// Field ficha_tecnica
		$this->ficha_tecnica->AdvancedSearch->SearchValue = @$filter["x_ficha_tecnica"];
		$this->ficha_tecnica->AdvancedSearch->SearchOperator = @$filter["z_ficha_tecnica"];
		$this->ficha_tecnica->AdvancedSearch->SearchCondition = @$filter["v_ficha_tecnica"];
		$this->ficha_tecnica->AdvancedSearch->SearchValue2 = @$filter["y_ficha_tecnica"];
		$this->ficha_tecnica->AdvancedSearch->SearchOperator2 = @$filter["w_ficha_tecnica"];
		$this->ficha_tecnica->AdvancedSearch->save();

		// Field img_principal
		$this->img_principal->AdvancedSearch->SearchValue = @$filter["x_img_principal"];
		$this->img_principal->AdvancedSearch->SearchOperator = @$filter["z_img_principal"];
		$this->img_principal->AdvancedSearch->SearchCondition = @$filter["v_img_principal"];
		$this->img_principal->AdvancedSearch->SearchValue2 = @$filter["y_img_principal"];
		$this->img_principal->AdvancedSearch->SearchOperator2 = @$filter["w_img_principal"];
		$this->img_principal->AdvancedSearch->save();
	...
	protected function basicSearchSql($arKeywords, $type)
	{
		...
		$this->buildBasicSearchSql($where, $this->img1, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->img2, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->img3, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->img4, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->img5, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->img6, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->img7, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->img8, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->img9, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->destacado_inicio, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->destacado_footer, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->destacado_productos, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->id_cate, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->ficha_tecnica, $arKeywords, $type);
	...
	protected function setupSortOrder()
	{
		...
		if (Get("order") !== NULL) {
			...
			$this->updateSort($this->img1, $ctrl); // img1
			$this->updateSort($this->destacado_inicio, $ctrl); // destacado_inicio
			$this->updateSort($this->destacado_footer, $ctrl); // destacado_footer
			$this->updateSort($this->destacado_productos, $ctrl); // destacado_productos
			$this->updateSort($this->id_cate, $ctrl); // id_cate
	...
	protected function resetCmd()
	{
		...
		if (substr($this->Command,0,5) == "reset") {
			...
			if ($this->Command == "resetsort") {
				...
				$this->titulo->setSort("");
				$this->img1->setSort("");
				$this->destacado_inicio->setSort("");
				$this->destacado_footer->setSort("");
				$this->destacado_productos->setSort("");
				$this->id_cate->setSort("");
			}
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-action ew-multi-delete\" title=\"" . HtmlTitle($Language->phrase("DeleteSelectedLink")) . "\" data-caption=\"" . HtmlTitle($Language->phrase("DeleteSelectedLink")) . "\" href=\"\" onclick=\"ew.submitAction(event,{f:document.fproductoslist,url:'" . $this->MultiDeleteUrl . "',data:{action:'show'}});return false;\">" . $Language->phrase("DeleteSelectedLink") . "</a>";
		$item->Visible = ($Security->canDelete());
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fproductoslistsrch\" href=\"#\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fproductoslistsrch\" href=\"#\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"\" onclick=\"ew.submitAction(event,jQuery.extend({f:document.fproductoslist}," . $listaction->toJson(TRUE) . "));return false;\">" . $icon . "</a>";
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fproductoslistsrch\">" . $Language->phrase("SearchLink") . "</button>";
		$item->Visible = TRUE;
