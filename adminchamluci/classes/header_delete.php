 ...
 * Page class
 */
class header_delete extends header
{
	...
	// Page object name
	public $PageObjName = "header_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("headerlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("headerlist.php"); // Return to list
			}
		}
	}
