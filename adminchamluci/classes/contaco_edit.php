 ...
 * Page class
 */
class contaco_edit extends contaco
{
	...
	// Page object name
	public $PageObjName = "contaco_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// tel1
			$this->tel1->setDbValueDef($rsnew, $this->tel1->CurrentValue, NULL, $this->tel1->ReadOnly);

			// tel2
			$this->tel2->setDbValueDef($rsnew, $this->tel2->CurrentValue, NULL, $this->tel2->ReadOnly);

			// tel3
			$this->tel3->setDbValueDef($rsnew, $this->tel3->CurrentValue, NULL, $this->tel3->ReadOnly);

			// tel4
			$this->tel4->setDbValueDef($rsnew, $this->tel4->CurrentValue, NULL, $this->tel4->ReadOnly);

			// tel5
			$this->tel5->setDbValueDef($rsnew, $this->tel5->CurrentValue, NULL, $this->tel5->ReadOnly);

			// horario
			$this->horario->setDbValueDef($rsnew, $this->horario->CurrentValue, NULL, $this->horario->ReadOnly);

			// img_bcp
			if ($this->img_bcp->Visible && !$this->img_bcp->ReadOnly && !$this->img_bcp->Upload->KeepFile) {
				$this->img_bcp->Upload->DbValue = $rsold['img_bcp']; // Get original value
			...
			// t_bcp1
			$this->t_bcp1->setDbValueDef($rsnew, $this->t_bcp1->CurrentValue, NULL, $this->t_bcp1->ReadOnly);

			// t_bcp2
			$this->t_bcp2->setDbValueDef($rsnew, $this->t_bcp2->CurrentValue, NULL, $this->t_bcp2->ReadOnly);

			// t_bcp3
			$this->t_bcp3->setDbValueDef($rsnew, $this->t_bcp3->CurrentValue, NULL, $this->t_bcp3->ReadOnly);

			// img_bbva
			if ($this->img_bbva->Visible && !$this->img_bbva->ReadOnly && !$this->img_bbva->Upload->KeepFile) {
				$this->img_bbva->Upload->DbValue = $rsold['img_bbva']; // Get original value
			...
			// t_bbva_1
			$this->t_bbva_1->setDbValueDef($rsnew, $this->t_bbva_1->CurrentValue, NULL, $this->t_bbva_1->ReadOnly);

			// t_bbva_2
			$this->t_bbva_2->setDbValueDef($rsnew, $this->t_bbva_2->CurrentValue, NULL, $this->t_bbva_2->ReadOnly);

			// t_bbva_3
			$this->t_bbva_3->setDbValueDef($rsnew, $this->t_bbva_3->CurrentValue, NULL, $this->t_bbva_3->ReadOnly);

			// fa
			$this->fa->setDbValueDef($rsnew, $this->fa->CurrentValue, NULL, $this->fa->ReadOnly);

			// tw
			$this->tw->setDbValueDef($rsnew, $this->tw->CurrentValue, NULL, $this->tw->ReadOnly);

			// in
			$this->in->setDbValueDef($rsnew, $this->in->CurrentValue, NULL, $this->in->ReadOnly);

			// go
			$this->go->setDbValueDef($rsnew, $this->go->CurrentValue, NULL, $this->go->ReadOnly);

			// you
			$this->you->setDbValueDef($rsnew, $this->you->CurrentValue, NULL, $this->you->ReadOnly);

			// correo_formulario
			$this->correo_formulario->setDbValueDef($rsnew, $this->correo_formulario->CurrentValue, NULL, $this->correo_formulario->ReadOnly);
			...
			if ($this->img_bcp->Visible && !$this->img_bcp->Upload->KeepFile) {
				...
				if (!EmptyValue($this->img_bcp->Upload->FileName)) {
					...
					$this->img_bcp->setDbValueDef($rsnew, $this->img_bcp->Upload->FileName, NULL, $this->img_bcp->ReadOnly);
				}
			}
			if ($this->img_bbva->Visible && !$this->img_bbva->Upload->KeepFile) {
				...
				if (!EmptyValue($this->img_bbva->Upload->FileName)) {
					...
					$this->img_bbva->setDbValueDef($rsnew, $this->img_bbva->Upload->FileName, NULL, $this->img_bbva->ReadOnly);
				}
			}
