 ...
 * Page class
 */
class laempresa_delete extends laempresa
{
	...
	// Page object name
	public $PageObjName = "laempresa_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("laempresalist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("laempresalist.php"); // Return to list
			}
		}
	}
