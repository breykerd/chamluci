 ...
 * Page class
 */
class blog_delete extends blog
{
	...
	// Page object name
	public $PageObjName = "blog_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("bloglist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("bloglist.php"); // Return to list
			}
		}
	}
