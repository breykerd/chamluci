 ...
 * Page class
 */
class contaco_view extends contaco
{
	...
	// Page object name
	public $PageObjName = "contaco_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "contacolist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "contacolist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "contacolist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
