	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "bloglist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "bloglist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "bloglist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
