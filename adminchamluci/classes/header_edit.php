 ...
 * Page class
 */
class header_edit extends header
{
	...
	// Page object name
	public $PageObjName = "header_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// img_empresa
			if ($this->img_empresa->Visible && !$this->img_empresa->ReadOnly && !$this->img_empresa->Upload->KeepFile) {
				$this->img_empresa->Upload->DbValue = $rsold['img_empresa']; // Get original value
			...
			// img_blog
			if ($this->img_blog->Visible && !$this->img_blog->ReadOnly && !$this->img_blog->Upload->KeepFile) {
				$this->img_blog->Upload->DbValue = $rsold['img_blog']; // Get original value
			...
			// img_contacto
			if ($this->img_contacto->Visible && !$this->img_contacto->ReadOnly && !$this->img_contacto->Upload->KeepFile) {
				$this->img_contacto->Upload->DbValue = $rsold['img_contacto']; // Get original value
			...
			// img_pasarela
			if ($this->img_pasarela->Visible && !$this->img_pasarela->ReadOnly && !$this->img_pasarela->Upload->KeepFile) {
				$this->img_pasarela->Upload->DbValue = $rsold['img_pasarela']; // Get original value
			...
			if ($this->img_empresa->Visible && !$this->img_empresa->Upload->KeepFile) {
				...
				if (!EmptyValue($this->img_empresa->Upload->FileName)) {
					...
					$this->img_empresa->setDbValueDef($rsnew, $this->img_empresa->Upload->FileName, NULL, $this->img_empresa->ReadOnly);
				}
			}
			if ($this->img_blog->Visible && !$this->img_blog->Upload->KeepFile) {
				...
				if (!EmptyValue($this->img_blog->Upload->FileName)) {
					...
					$this->img_blog->setDbValueDef($rsnew, $this->img_blog->Upload->FileName, NULL, $this->img_blog->ReadOnly);
				}
			}
			if ($this->img_contacto->Visible && !$this->img_contacto->Upload->KeepFile) {
				...
				if (!EmptyValue($this->img_contacto->Upload->FileName)) {
					...
					$this->img_contacto->setDbValueDef($rsnew, $this->img_contacto->Upload->FileName, NULL, $this->img_contacto->ReadOnly);
				}
			}
			if ($this->img_pasarela->Visible && !$this->img_pasarela->Upload->KeepFile) {
				...
				if (!EmptyValue($this->img_pasarela->Upload->FileName)) {
					...
					$this->img_pasarela->setDbValueDef($rsnew, $this->img_pasarela->Upload->FileName, NULL, $this->img_pasarela->ReadOnly);
				}
			}
