 ...
 * Page class
 */
class contaco_delete extends contaco
{
	...
	// Page object name
	public $PageObjName = "contaco_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("contacolist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("contacolist.php"); // Return to list
			}
		}
	}
