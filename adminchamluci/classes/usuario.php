...
class usuario extends DbTable
{
	...
	public function __construct()
	{
		...
		// user
		$this->user = new DbField('usuario', 'usuario', 'x_user', 'user', '`user`', '`user`', 200, -1, FALSE, '`user`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->user->Required = TRUE; // Required field
		$this->user->Sortable = TRUE; // Allow sort
		$this->fields['user'] = &$this->user;

		// clave
		$this->clave = new DbField('usuario', 'usuario', 'x_clave', 'clave', '`clave`', '`clave`', 200, -1, FALSE, '`clave`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
