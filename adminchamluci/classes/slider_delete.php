 ...
 * Page class
 */
class slider_delete extends slider
{
	...
	// Page object name
	public $PageObjName = "slider_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("sliderlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("sliderlist.php"); // Return to list
			}
		}
	}
