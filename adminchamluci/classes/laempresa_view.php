 ...
 * Page class
 */
class laempresa_view extends laempresa
{
	...
	// Page object name
	public $PageObjName = "laempresa_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "laempresalist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "laempresalist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "laempresalist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
