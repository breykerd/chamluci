 ...
 * Page class
 */
class laempresa_edit extends laempresa
{
	...
	// Page object name
	public $PageObjName = "laempresa_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// tituloimg
			$this->tituloimg->setDbValueDef($rsnew, $this->tituloimg->CurrentValue, "", $this->tituloimg->ReadOnly);
