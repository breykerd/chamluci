 ...
 * Page class
 */
class productos_add extends productos
{
	...
	// Page object name
	public $PageObjName = "productos_add";
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "productosview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->ficha_tecnica->CurrentValue = NULL; // Clear file related field
		$this->img_principal->CurrentValue = NULL;
		$this->img_principal->OldValue = $this->img_principal->CurrentValue;
		$this->img_principal->CurrentValue = NULL; // Clear file related field
	...
	protected function addRow($rsold = NULL)
	{
		...
		if ($this->img2->Visible && !$this->img2->Upload->KeepFile) {
			$this->img2->Upload->DbValue = ""; // No need to delete old file
		...
		if ($this->img3->Visible && !$this->img3->Upload->KeepFile) {
			$this->img3->Upload->DbValue = ""; // No need to delete old file
		...
		if ($this->img4->Visible && !$this->img4->Upload->KeepFile) {
			$this->img4->Upload->DbValue = ""; // No need to delete old file
		...
		if ($this->img5->Visible && !$this->img5->Upload->KeepFile) {
			$this->img5->Upload->DbValue = ""; // No need to delete old file
		...
		if ($this->img6->Visible && !$this->img6->Upload->KeepFile) {
			$this->img6->Upload->DbValue = ""; // No need to delete old file
		...
		if ($this->img7->Visible && !$this->img7->Upload->KeepFile) {
			$this->img7->Upload->DbValue = ""; // No need to delete old file
		...
		if ($this->img8->Visible && !$this->img8->Upload->KeepFile) {
			$this->img8->Upload->DbValue = ""; // No need to delete old file
		...
		if ($this->img9->Visible && !$this->img9->Upload->KeepFile) {
			$this->img9->Upload->DbValue = ""; // No need to delete old file
		...
		if ($this->ficha_tecnica->Visible && !$this->ficha_tecnica->Upload->KeepFile) {
			$this->ficha_tecnica->Upload->DbValue = ""; // No need to delete old file
		...
		if ($this->img2->Visible && !$this->img2->Upload->KeepFile) {
			...
			if (!EmptyValue($this->img2->Upload->FileName)) {
				...
				$this->img2->setDbValueDef($rsnew, $this->img2->Upload->FileName, NULL, FALSE);
			}
		}
		if ($this->img3->Visible && !$this->img3->Upload->KeepFile) {
			...
			if (!EmptyValue($this->img3->Upload->FileName)) {
				...
				$this->img3->setDbValueDef($rsnew, $this->img3->Upload->FileName, NULL, FALSE);
			}
		}
		if ($this->img4->Visible && !$this->img4->Upload->KeepFile) {
			...
			if (!EmptyValue($this->img4->Upload->FileName)) {
				...
				$this->img4->setDbValueDef($rsnew, $this->img4->Upload->FileName, NULL, FALSE);
			}
		}
		if ($this->img5->Visible && !$this->img5->Upload->KeepFile) {
			...
			if (!EmptyValue($this->img5->Upload->FileName)) {
				...
				$this->img5->setDbValueDef($rsnew, $this->img5->Upload->FileName, NULL, FALSE);
			}
		}
		if ($this->img6->Visible && !$this->img6->Upload->KeepFile) {
			...
			if (!EmptyValue($this->img6->Upload->FileName)) {
				...
				$this->img6->setDbValueDef($rsnew, $this->img6->Upload->FileName, NULL, FALSE);
			}
		}
		if ($this->img7->Visible && !$this->img7->Upload->KeepFile) {
			...
			if (!EmptyValue($this->img7->Upload->FileName)) {
				...
				$this->img7->setDbValueDef($rsnew, $this->img7->Upload->FileName, NULL, FALSE);
			}
		}
		if ($this->img8->Visible && !$this->img8->Upload->KeepFile) {
			...
			if (!EmptyValue($this->img8->Upload->FileName)) {
				...
				$this->img8->setDbValueDef($rsnew, $this->img8->Upload->FileName, NULL, FALSE);
			}
		}
		if ($this->img9->Visible && !$this->img9->Upload->KeepFile) {
			...
			if (!EmptyValue($this->img9->Upload->FileName)) {
				...
				$this->img9->setDbValueDef($rsnew, $this->img9->Upload->FileName, NULL, FALSE);
			}
		}
		if ($this->ficha_tecnica->Visible && !$this->ficha_tecnica->Upload->KeepFile) {
			...
			if (!EmptyValue($this->ficha_tecnica->Upload->FileName)) {
				...
				$this->ficha_tecnica->setDbValueDef($rsnew, $this->ficha_tecnica->Upload->FileName, NULL, FALSE);
			}
		}
