 ...
 * Page class
 */
class cotizaciones_view extends cotizaciones
{
	...
	// Page object name
	public $PageObjName = "cotizaciones_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "cotizacioneslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "cotizacioneslist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "cotizacioneslist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
