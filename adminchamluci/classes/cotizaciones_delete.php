 ...
 * Page class
 */
class cotizaciones_delete extends cotizaciones
{
	...
	// Page object name
	public $PageObjName = "cotizaciones_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("cotizacioneslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("cotizacioneslist.php"); // Return to list
			}
		}
	}
