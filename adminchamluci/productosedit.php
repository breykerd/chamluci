...
// Create page object
$productos_edit = new productos_edit();
...
var fproductosedit = currentForm = new ew.Form("fproductosedit", "edit");
...
fproductosedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($productos_edit->titulo->Required) { ?>
		...
		<?php } ?>
		<?php if ($productos_edit->detalle->Required) { ?>
		...
		<?php } ?>
		<?php if ($productos_edit->img1->Required) { ?>
		...
		<?php } ?>
		<?php if ($productos_edit->img2->Required) { ?>
		...
		<?php } ?>
		<?php if ($productos_edit->img3->Required) { ?>
		...
		<?php } ?>
		<?php if ($productos_edit->img4->Required) { ?>
		...
		<?php } ?>
		<?php if ($productos_edit->img5->Required) { ?>
		...
		<?php } ?>
		<?php if ($productos_edit->img6->Required) { ?>
		...
		<?php } ?>
		<?php if ($productos_edit->img7->Required) { ?>
		...
		<?php } ?>
		<?php if ($productos_edit->img8->Required) { ?>
		...
		<?php } ?>
		<?php if ($productos_edit->img9->Required) { ?>
		...
		<?php } ?>
		<?php if ($productos_edit->destacado_inicio->Required) { ?>
		...
		<?php } ?>
		<?php if ($productos_edit->destacado_footer->Required) { ?>
		...
		<?php } ?>
		<?php if ($productos_edit->destacado_productos->Required) { ?>
		...
		<?php } ?>
		<?php if ($productos_edit->id_cate->Required) { ?>
		...
		<?php } ?>
		<?php if ($productos_edit->ficha_tecnica->Required) { ?>
		...
		<?php } ?>
		<?php if ($productos_edit->img_principal->Required) { ?>
		...
		<?php } ?>
		<?php if ($productos_edit->url->Required) { ?>
		...
		<?php } ?>
		<?php if ($productos_edit->keywords->Required) { ?>
		...
		<?php } ?>
		<?php if ($productos_edit->description->Required) { ?>
...
fproductosedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fproductosedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fproductosedit.lists["x_destacado_inicio"] = <?php echo $productos_edit->destacado_inicio->Lookup->toClientList() ?>;
fproductosedit.lists["x_destacado_inicio"].options = <?php echo JsonEncode($productos_edit->destacado_inicio->options(FALSE, TRUE)) ?>;
fproductosedit.lists["x_destacado_footer"] = <?php echo $productos_edit->destacado_footer->Lookup->toClientList() ?>;
fproductosedit.lists["x_destacado_footer"].options = <?php echo JsonEncode($productos_edit->destacado_footer->options(FALSE, TRUE)) ?>;
fproductosedit.lists["x_destacado_productos"] = <?php echo $productos_edit->destacado_productos->Lookup->toClientList() ?>;
fproductosedit.lists["x_destacado_productos"].options = <?php echo JsonEncode($productos_edit->destacado_productos->options(FALSE, TRUE)) ?>;
fproductosedit.lists["x_id_cate"] = <?php echo $productos_edit->id_cate->Lookup->toClientList() ?>;
fproductosedit.lists["x_id_cate"].options = <?php echo JsonEncode($productos_edit->id_cate->lookupOptions()) ?>;
fproductosedit.lists["x_img_principal"] = <?php echo $productos_edit->img_principal->Lookup->toClientList() ?>;
fproductosedit.lists["x_img_principal"].options = <?php echo JsonEncode($productos_edit->img_principal->options(FALSE, TRUE)) ?>;
...
?>
<form name="fproductosedit" id="fproductosedit" class="<?php echo $productos_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($productos_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $productos_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="productos">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$productos_edit->IsModal ?>">
...
<?php if ($productos->titulo->Visible) { // titulo ?>
	<div id="r_titulo" class="form-group row">
		<label id="elh_productos_titulo" for="x_titulo" class="<?php echo $productos_edit->LeftColumnClass ?>"><?php echo $productos->titulo->caption() ?><?php echo ($productos->titulo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $productos_edit->RightColumnClass ?>"><div<?php echo $productos->titulo->cellAttributes() ?>>
...
<?php if ($productos->detalle->Visible) { // detalle ?>
	<div id="r_detalle" class="form-group row">
		<label id="elh_productos_detalle" class="<?php echo $productos_edit->LeftColumnClass ?>"><?php echo $productos->detalle->caption() ?><?php echo ($productos->detalle->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $productos_edit->RightColumnClass ?>"><div<?php echo $productos->detalle->cellAttributes() ?>>
...
<script>
ew.createEditor("fproductosedit", "x_detalle", 300, 6, <?php echo ($productos->detalle->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
...
<?php if ($productos->img1->Visible) { // img1 ?>
	<div id="r_img1" class="form-group row">
		<label id="elh_productos_img1" class="<?php echo $productos_edit->LeftColumnClass ?>"><?php echo $productos->img1->caption() ?><?php echo ($productos->img1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $productos_edit->RightColumnClass ?>"><div<?php echo $productos->img1->cellAttributes() ?>>
...
<?php if (Post("fa_x_img1") == "0") { ?>
<input type="hidden" name="fa_x_img1" id= "fa_x_img1" value="0">
<?php } else { ?>
<input type="hidden" name="fa_x_img1" id= "fa_x_img1" value="1">
<?php } ?>
...
<?php if ($productos->img2->Visible) { // img2 ?>
	<div id="r_img2" class="form-group row">
		<label id="elh_productos_img2" class="<?php echo $productos_edit->LeftColumnClass ?>"><?php echo $productos->img2->caption() ?><?php echo ($productos->img2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $productos_edit->RightColumnClass ?>"><div<?php echo $productos->img2->cellAttributes() ?>>
...
<?php if ($productos->img3->Visible) { // img3 ?>
	<div id="r_img3" class="form-group row">
		<label id="elh_productos_img3" class="<?php echo $productos_edit->LeftColumnClass ?>"><?php echo $productos->img3->caption() ?><?php echo ($productos->img3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $productos_edit->RightColumnClass ?>"><div<?php echo $productos->img3->cellAttributes() ?>>
...
<?php if ($productos->img4->Visible) { // img4 ?>
	<div id="r_img4" class="form-group row">
		<label id="elh_productos_img4" class="<?php echo $productos_edit->LeftColumnClass ?>"><?php echo $productos->img4->caption() ?><?php echo ($productos->img4->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $productos_edit->RightColumnClass ?>"><div<?php echo $productos->img4->cellAttributes() ?>>
...
<?php if ($productos->img5->Visible) { // img5 ?>
	<div id="r_img5" class="form-group row">
		<label id="elh_productos_img5" class="<?php echo $productos_edit->LeftColumnClass ?>"><?php echo $productos->img5->caption() ?><?php echo ($productos->img5->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $productos_edit->RightColumnClass ?>"><div<?php echo $productos->img5->cellAttributes() ?>>
...
<?php if (Post("fa_x_img5") == "0") { ?>
<input type="hidden" name="fa_x_img5" id= "fa_x_img5" value="0">
<?php } else { ?>
<input type="hidden" name="fa_x_img5" id= "fa_x_img5" value="1">
<?php } ?>
...
<?php if ($productos->img6->Visible) { // img6 ?>
	<div id="r_img6" class="form-group row">
		<label id="elh_productos_img6" class="<?php echo $productos_edit->LeftColumnClass ?>"><?php echo $productos->img6->caption() ?><?php echo ($productos->img6->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $productos_edit->RightColumnClass ?>"><div<?php echo $productos->img6->cellAttributes() ?>>
...
<?php if (Post("fa_x_img6") == "0") { ?>
<input type="hidden" name="fa_x_img6" id= "fa_x_img6" value="0">
<?php } else { ?>
<input type="hidden" name="fa_x_img6" id= "fa_x_img6" value="1">
<?php } ?>
...
<?php if ($productos->img7->Visible) { // img7 ?>
	<div id="r_img7" class="form-group row">
		<label id="elh_productos_img7" class="<?php echo $productos_edit->LeftColumnClass ?>"><?php echo $productos->img7->caption() ?><?php echo ($productos->img7->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $productos_edit->RightColumnClass ?>"><div<?php echo $productos->img7->cellAttributes() ?>>
...
<?php if (Post("fa_x_img7") == "0") { ?>
<input type="hidden" name="fa_x_img7" id= "fa_x_img7" value="0">
<?php } else { ?>
<input type="hidden" name="fa_x_img7" id= "fa_x_img7" value="1">
<?php } ?>
...
<?php if ($productos->img8->Visible) { // img8 ?>
	<div id="r_img8" class="form-group row">
		<label id="elh_productos_img8" class="<?php echo $productos_edit->LeftColumnClass ?>"><?php echo $productos->img8->caption() ?><?php echo ($productos->img8->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $productos_edit->RightColumnClass ?>"><div<?php echo $productos->img8->cellAttributes() ?>>
...
<?php if (Post("fa_x_img8") == "0") { ?>
<input type="hidden" name="fa_x_img8" id= "fa_x_img8" value="0">
<?php } else { ?>
<input type="hidden" name="fa_x_img8" id= "fa_x_img8" value="1">
<?php } ?>
...
<?php if ($productos->img9->Visible) { // img9 ?>
	<div id="r_img9" class="form-group row">
		<label id="elh_productos_img9" class="<?php echo $productos_edit->LeftColumnClass ?>"><?php echo $productos->img9->caption() ?><?php echo ($productos->img9->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $productos_edit->RightColumnClass ?>"><div<?php echo $productos->img9->cellAttributes() ?>>
...
<?php if (Post("fa_x_img9") == "0") { ?>
<input type="hidden" name="fa_x_img9" id= "fa_x_img9" value="0">
<?php } else { ?>
<input type="hidden" name="fa_x_img9" id= "fa_x_img9" value="1">
<?php } ?>
...
<?php if ($productos->destacado_inicio->Visible) { // destacado_inicio ?>
	<div id="r_destacado_inicio" class="form-group row">
		<label id="elh_productos_destacado_inicio" class="<?php echo $productos_edit->LeftColumnClass ?>"><?php echo $productos->destacado_inicio->caption() ?><?php echo ($productos->destacado_inicio->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $productos_edit->RightColumnClass ?>"><div<?php echo $productos->destacado_inicio->cellAttributes() ?>>
...
<?php if ($productos->destacado_footer->Visible) { // destacado_footer ?>
	<div id="r_destacado_footer" class="form-group row">
		<label id="elh_productos_destacado_footer" class="<?php echo $productos_edit->LeftColumnClass ?>"><?php echo $productos->destacado_footer->caption() ?><?php echo ($productos->destacado_footer->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $productos_edit->RightColumnClass ?>"><div<?php echo $productos->destacado_footer->cellAttributes() ?>>
...
<?php if ($productos->destacado_productos->Visible) { // destacado_productos ?>
	<div id="r_destacado_productos" class="form-group row">
		<label id="elh_productos_destacado_productos" class="<?php echo $productos_edit->LeftColumnClass ?>"><?php echo $productos->destacado_productos->caption() ?><?php echo ($productos->destacado_productos->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $productos_edit->RightColumnClass ?>"><div<?php echo $productos->destacado_productos->cellAttributes() ?>>
...
<?php if ($productos->id_cate->Visible) { // id_cate ?>
	<div id="r_id_cate" class="form-group row">
		<label id="elh_productos_id_cate" for="x_id_cate" class="<?php echo $productos_edit->LeftColumnClass ?>"><?php echo $productos->id_cate->caption() ?><?php echo ($productos->id_cate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $productos_edit->RightColumnClass ?>"><div<?php echo $productos->id_cate->cellAttributes() ?>>
...
<?php if ($productos->ficha_tecnica->Visible) { // ficha_tecnica ?>
	<div id="r_ficha_tecnica" class="form-group row">
		<label id="elh_productos_ficha_tecnica" class="<?php echo $productos_edit->LeftColumnClass ?>"><?php echo $productos->ficha_tecnica->caption() ?><?php echo ($productos->ficha_tecnica->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $productos_edit->RightColumnClass ?>"><div<?php echo $productos->ficha_tecnica->cellAttributes() ?>>
...
<?php if (Post("fa_x_ficha_tecnica") == "0") { ?>
<input type="hidden" name="fa_x_ficha_tecnica" id= "fa_x_ficha_tecnica" value="0">
<?php } else { ?>
<input type="hidden" name="fa_x_ficha_tecnica" id= "fa_x_ficha_tecnica" value="1">
<?php } ?>
...
<?php if ($productos->img_principal->Visible) { // img_principal ?>
	<div id="r_img_principal" class="form-group row">
		<label id="elh_productos_img_principal" for="x_img_principal" class="<?php echo $productos_edit->LeftColumnClass ?>"><?php echo $productos->img_principal->caption() ?><?php echo ($productos->img_principal->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $productos_edit->RightColumnClass ?>"><div<?php echo $productos->img_principal->cellAttributes() ?>>
...
<?php if ($productos->url->Visible) { // url ?>
	<div id="r_url" class="form-group row">
		<label id="elh_productos_url" for="x_url" class="<?php echo $productos_edit->LeftColumnClass ?>"><?php echo $productos->url->caption() ?><?php echo ($productos->url->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $productos_edit->RightColumnClass ?>"><div<?php echo $productos->url->cellAttributes() ?>>
...
<?php if ($productos->keywords->Visible) { // keywords ?>
	<div id="r_keywords" class="form-group row">
		<label id="elh_productos_keywords" for="x_keywords" class="<?php echo $productos_edit->LeftColumnClass ?>"><?php echo $productos->keywords->caption() ?><?php echo ($productos->keywords->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $productos_edit->RightColumnClass ?>"><div<?php echo $productos->keywords->cellAttributes() ?>>
...
<?php if ($productos->description->Visible) { // description ?>
	<div id="r_description" class="form-group row">
		<label id="elh_productos_description" for="x_description" class="<?php echo $productos_edit->LeftColumnClass ?>"><?php echo $productos->description->caption() ?><?php echo ($productos->description->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $productos_edit->RightColumnClass ?>"><div<?php echo $productos->description->cellAttributes() ?>>
...
<?php } ?>
	...
	<input type="hidden" data-table="productos" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($productos->id->CurrentValue) ?>">
...
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $productos_edit->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
