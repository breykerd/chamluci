...
var fblogadd = currentForm = new ew.Form("fblogadd", "add");
...
fblogadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php } ?>
		<?php if ($blog_add->titulo->Required) { ?>
		...
		<?php } ?>
		<?php if ($blog_add->detalle->Required) { ?>
		...
		<?php } ?>
		<?php if ($blog_add->detalle2->Required) { ?>
		...
		<?php } ?>
		<?php if ($blog_add->keywords->Required) { ?>
		...
		<?php } ?>
		<?php if ($blog_add->description->Required) { ?>
...
fblogadd.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fblogadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
?>
<form name="fblogadd" id="fblogadd" class="<?php echo $blog_add->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($blog_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $blog_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="blog">
<input type="hidden" name="action" id="action" value="insert">
<input type="hidden" name="modal" value="<?php echo (int)$blog_add->IsModal ?>">
<div class="ew-add-div"><!-- page* -->
<?php if ($blog->img->Visible) { // img ?>
	<div id="r_img" class="form-group row">
		<label id="elh_blog_img" class="<?php echo $blog_add->LeftColumnClass ?>"><?php echo $blog->img->caption() ?><?php echo ($blog->img->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $blog_add->RightColumnClass ?>"><div<?php echo $blog->img->cellAttributes() ?>>
<span id="el_blog_img">
<div id="fd_x_img">
...
<?php if ($blog->titulo->Visible) { // titulo ?>
	<div id="r_titulo" class="form-group row">
		<label id="elh_blog_titulo" for="x_titulo" class="<?php echo $blog_add->LeftColumnClass ?>"><?php echo $blog->titulo->caption() ?><?php echo ($blog->titulo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $blog_add->RightColumnClass ?>"><div<?php echo $blog->titulo->cellAttributes() ?>>
...
<?php if ($blog->detalle->Visible) { // detalle ?>
	<div id="r_detalle" class="form-group row">
		<label id="elh_blog_detalle" class="<?php echo $blog_add->LeftColumnClass ?>"><?php echo $blog->detalle->caption() ?><?php echo ($blog->detalle->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $blog_add->RightColumnClass ?>"><div<?php echo $blog->detalle->cellAttributes() ?>>
...
<script>
ew.createEditor("fblogadd", "x_detalle", 35, 4, <?php echo ($blog->detalle->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
...
<?php if ($blog->detalle2->Visible) { // detalle2 ?>
	<div id="r_detalle2" class="form-group row">
		<label id="elh_blog_detalle2" class="<?php echo $blog_add->LeftColumnClass ?>"><?php echo $blog->detalle2->caption() ?><?php echo ($blog->detalle2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $blog_add->RightColumnClass ?>"><div<?php echo $blog->detalle2->cellAttributes() ?>>
...
<script>
ew.createEditor("fblogadd", "x_detalle2", 35, 4, <?php echo ($blog->detalle2->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
...
<?php if ($blog->url->Visible) { // url ?>
	<div id="r_url" class="form-group row">
		<label id="elh_blog_url" for="x_url" class="<?php echo $blog_add->LeftColumnClass ?>"><?php echo $blog->url->caption() ?><?php echo ($blog->url->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $blog_add->RightColumnClass ?>"><div<?php echo $blog->url->cellAttributes() ?>>
<span id="el_blog_url">
...
<?php if ($blog->keywords->Visible) { // keywords ?>
	<div id="r_keywords" class="form-group row">
		<label id="elh_blog_keywords" class="<?php echo $blog_add->LeftColumnClass ?>"><?php echo $blog->keywords->caption() ?><?php echo ($blog->keywords->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $blog_add->RightColumnClass ?>"><div<?php echo $blog->keywords->cellAttributes() ?>>
...
<script>
ew.createEditor("fblogadd", "x_keywords", 35, 4, <?php echo ($blog->keywords->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
...
<?php if ($blog->description->Visible) { // description ?>
	<div id="r_description" class="form-group row">
		<label id="elh_blog_description" for="x_description" class="<?php echo $blog_add->LeftColumnClass ?>"><?php echo $blog->description->caption() ?><?php echo ($blog->description->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $blog_add->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
